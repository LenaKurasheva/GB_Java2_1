    ...
    private void readMessages() throws IOException {
        while (true) {
            if (in.available()>0) {
                ...
                //  Обработка личныех сообщений типа «/w nick3 Привет»
                if (message.startsWith("/w")){
                    ...
                    System.out.println("From " + name + " to " +parts[1] + ": " + message);
                    myServer.sendPrivateMsg(this, parts[1],message);
                }
                else {
                    System.out.print("From " + name + ":" + message + "\n");
